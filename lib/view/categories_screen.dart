          ...
          children: [
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                            color: categoryName == categoriesList[index] ?  Colors.purple :Colors.grey,
                            borderRadius: BorderRadius.circular(20)),
                        child: Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 12),
                          child: Center(child: Text(categoriesList[index],style: 
                          GoogleFonts.poppins(
                            fontSize: 13,
                            color: Colors.white
                          )),
            ...
            Expanded(
              child: FutureBuilder<CategoriesNewsModeI>(
                future: newsViewModel.fetchCategoriesNewsApi(categories: categoryName),
